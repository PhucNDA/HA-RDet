...
class MidpointRotatedConvFCBBoxHead(MidpointRotatedBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(MidpointRotatedConvFCBBoxHead, self).__init__(
        ...
        if self.with_reg:
            out_dim_reg = (6 if self.reg_class_agnostic else 6 *
                           self.num_classes)
...
@ROTATED_HEADS.register_module()
class MidpointRotatedShared2FCBBoxHead(MidpointRotatedConvFCBBoxHead):
    """Shared2FC RBBox head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(MidpointRotatedShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
