...
class AlignmentRoITransRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(AlignmentRoITransRoIHead, self).__init__(init_cfg)

        self.align_conv_type = 'AlignConv'
        self.align_conv_size = 3
        self.feat_channels = 256
        self.featmap_strides = [8, 16, 32, 64, 128]
    ...
    def _bbox_forward(self, stage, x, rois):
        ...
        if(stage==0):
            ...
            bbox_feats = self.align_conv(x, rois)
